      ...
      <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="66px">
        ...
        <el-form-item label="上传">
          <el-upload ref="upload" :limit="1" :before-upload="beforeUpload" :auto-upload="false"
            :on-success="handleSuccess" :on-error="handleError" :action="storageApi + '/upload?name=' + form.name">
            <div class="upload">
    ...
    <el-table ref="multipleTable" v-loading="listLoading" :data="list" size="small" style="width: 90%;"
      ...
      <el-table-column label="文件名" prop="name" sortable="custom" align="center" width="150px">
        <template slot-scope="scope">
          <el-popover :content="storageApi + scope.row.url" placement="top-start" title="路径" width="200"
            trigger="hover">
            <a slot="reference" :href="storageApi + scope.row.url" class="el-link--primary"
      ...
      <el-table-column label="预览图" prop="url" align="center">
        <template slot-scope="{row}">
          <el-image :src="storageApi + row.url" :preview-src-list="[storageApi + row.url]" fit="contain" lazy
            class="el-avatar">
            <div slot="error">
